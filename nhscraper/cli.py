            ...
            for line in f:
                ...
                if m_homepage:
                    ...
                    result = executor.run_blocking(
                        fetch_gallery_ids, "homepage", None, sort_val, start_page, end_page,
                ...
                if m_query:
                    ...
                    result = executor.run_blocking(
                        fetch_gallery_ids, qtype, qvalue, sort_val, start_page, end_page,
                        referrer_blocking=_module_referrer
                    )
                    if result:
                        gallery_ids.update(result)
                    ...
                    result = executor.run_blocking(
                        fetch_gallery_ids, "search", search_query, sort_val, start_page, end_page,
                        referrer_blocking=_module_referrer
                    )
                    if result:
                        gallery_ids.update(result)
