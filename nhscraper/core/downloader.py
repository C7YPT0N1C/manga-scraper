...
def worst_case_time_estimate(context: str, id_list: list):
    ...
    log_clarification()
    logger.warning(f"{context} Worst Case Time Estimate ({current_run_num_of_galleries} Galleries)= {worst_time_mins:.2f} Minutes / {worst_time_days:.2f} Hours / {worst_time_hours:.2f} Days")
